...
if __name__ == '__main__':
    ...
    elif lr_method == "warm_incr_const":
        scheduler = optim.lr_scheduler.LambdaLR(optimizer, warm_incr_const_lr_lambda)

    elif lr_method == "warm_incr_cosine":
        scheduler = optim.lr_scheduler.LambdaLR(optimizer, warm_incr_cosine_lr_lambda)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if lr_method in ["cosine", "exp_growth", "warm_incr_const", "warm_incr_cosine", "triply_incr_bs", "quadruply_incr_bs"]:
            scheduler.step()
    ...
    elif lr_method in ["exp_growth", "warm_incr_const", "warm_incr_cosine", "triply_incr_bs", "quadruply_incr_bs"]:
